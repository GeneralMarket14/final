...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    Route::group(['middleware' => ['app_user_unbanned']], function () {
        ...
        Route::get('chat/get-new-messages', 'App\Http\Controllers\Api\V2\ChatController@get_new_messages')->middleware('auth:sanctum');
    ...
    Route::get('products/retailer/{id}', 'App\Http\Controllers\Api\V2\ProductController@retailer');
    Route::get('products/manufacturer/{id}', 'App\Http\Controllers\Api\V2\ProductController@manufacturer');
    ...
    Route::get('ads', 'App\Http\Controllers\Api\V2\ProductController@indexAd');
